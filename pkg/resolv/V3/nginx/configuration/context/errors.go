...
var (
	...
	ErrInsertIntoErrorContext      = errors.WithCode(code.V3ErrOperationOnErrorContext, "insert context into an error context")
	ErrRemoveFromErrorContext      = errors.WithCode(code.V3ErrOperationOnErrorContext, "remove context from an error context")
	ErrModifyFromErrorContext      = errors.WithCode(code.V3ErrOperationOnErrorContext, "modify context from an error context")
	ErrSetValueToErrorContext      = errors.WithCode(code.V3ErrOperationOnErrorContext, "set value to an error context")
	ErrSetFatherToErrorContext     = errors.WithCode(code.V3ErrOperationOnErrorContext, "set father to an error context")
	...
	ErrNullPosition                = errors.WithCode(code.V3ErrNullContextPosition, "null position")
