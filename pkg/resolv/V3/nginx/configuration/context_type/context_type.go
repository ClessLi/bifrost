...
const (
	...
	TypeDirUninitializedProxyPass ContextType = "dir_uninitialized_proxy_pass"
	TypeDirHTTPProxyPass          ContextType = "dir_http_proxy_pass"
	TypeDirStreamProxyPass        ContextType = "dir_stream_proxy_pass"
